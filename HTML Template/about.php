...
<section
  ...
  style="background-image: url(assets/images/about-farmer1.jpg)">
  <div class="container">
...
<section class="about-page-section rel z-1 py-130 rpy-100">
      ...
      <div class="col-lg-6">
        <div class="about-three-content rmb-35 wow fadeInLeft delay-0-2s">
          <div class="section-title mb-20">
            ...
            <h2>Organic & Helathy Foods Provider Company</h2>
          </div>
          <p>
          VK FOOD PROCESS is one of the leading manufacturers and 
          suppliers of dehydrated onion, dehydrated garlic, dehydrated 
          ginger, moringa powder and other agricultural commodities.The 
          company is based in Nashik which is leading agricultural hub of 
          india.
          </p>
          <div class="row mt-30">
            <div class="col-md-6">
              <div class="about-feature-two">
                ...
                <h4><a href="service-details.html">Organic Powder</a></h4>
              </div>
            </div>
            <div class="col-md-6">
              <div class="about-feature-two">
                <div class="icon"><i class="flaticon-fruits"></i></div>
                <h4><a href="service-details.html">Organic Flakes</a></h4>
              </div>
            </div>
  ...
  <img src="assets/images/shapes/about-page.png" alt="Shape" class="shape" />
</section>
<!-- About Section End -->
      ...
      <div class="col-xl-4 col-md-6">
        <div class="feature-item wow fadeInUp delay-0-2s">
          <div class="content">
            ...
            <div class="image">
              <img src="assets/images/GreenBrocelli.png" alt="Feature" />
            </div>
            <h4>Organic Vegetables</h4>
            <p>
              Quis autem vel eum reprehenderit quiea voluptate velit esse quam
              niyate smolestiae consequatur nulla
            </p>
          </div>
      ...
      <div class="col-xl-4 col-md-6">
        <div class="feature-item color-two wow fadeInUp delay-0-4s">
          <div class="content">
            ...
            <div class="image">
              <img src="assets/images/BouncingFood.png" alt="Feature" />
            </div>
      ...
      <div class="col-xl-4 col-md-6">
        <div class="feature-item color-three wow fadeInUp delay-0-6s">
          <div class="content">
            ...
            <div class="image">
              <img src="assets/images/foods.png" alt="Feature" />
            </div>
    ...
    <div class="gallery-active">
      <div class="gallery-item wow fadeInUp delay-0-2s">
        ...
        <div class="gallery-over">
          <div class="content">
            <h4><a href="portfolio-details.html">Organic Fruits</a></h4>
            <p>Fresh Food</p>
          </div>
      ...
      <div class="gallery-item big-item wow fadeInUp delay-0-4s">
        ...
        <div class="gallery-over">
          <div class="content">
            <h4><a href="portfolio-details.html">Organic Fruits Juice</a></h4>
            ...
            <div class="row">
              <div class="col-xl-4 col-md-6">
                <div class="about-feature-item wow fadeInUp delay-0-5s">
                  ...
                  <h4><a href="service-details.html">Discount Options</a></h4>
              ...
              <div class="col-xl-4 col-md-6">
                <div class="about-feature-item wow fadeInUp delay-0-6s">
                  ...
                  <h4><a href="service-details.html">Best Return Policy</a></h4>
                  <p>Sit amet consectetur adipis cing elit sed eiusmoe</p>
                  <img src="assets/images/about/arrow.png" alt="Arrow" />
                </div>
              </div>
              <div class="col-xl-4 col-md-6">
                <div class="about-feature-item wow fadeInUp delay-0-7s">
                  ...
                  <h4><a href="service-details.html">Online Support</a></h4>
                  <p>Sit amet consectetur adipis cing elit sed eiusmoe</p>
                  <img src="assets/images/about/arrow.png" alt="Arrow" />
                </div>
              </div>
  ...
  <div class="feedback-two-active mt-20">
    <div class="feedback-item style-two wow fadeInUp delay-0-2s">
      <div class="content-image">
        <p>
          ...
          dolore magna aliqae euisum suspendisse ultrices gravid aisuscom vivera
          accumsan facilisis
        </p>
        <div class="image">
          <img src="assets/images/reviews/feedback-author1.jpg" alt="Authro" />
          <img
            class="bg"
    ...
    <div class="feedback-item style-two wow fadeInUp delay-0-3s">
      <div class="content-image">
        ...
        <div class="image">
          <img src="assets/images/reviews/feedback-author2.jpg" alt="Authro" />
          <img
            class="bg"
            src="assets/images/reviews/feedback-author-bg.png"
            alt="Background"
